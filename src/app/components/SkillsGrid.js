        ...
        <>
            <section className="py-12 px-4 bg-gray-100 dark:bg-slate-950 overflow-hidden border-t border-gray-800" id="pandavas">
                <div className="text-center mb-8">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Tools and technologies I use to build modern web applications</p>
                </div>
                <div className=" grid grid-cols-8">
                    ...
                    <div className="grid col-span-8 lg:col-span-6 grid-cols-3 grid-rows-3 gap-4">
                        <div className="relative col-span-3 md:col-span-2 row-span-1 md:row-span-2 bg-sky-200 aspect-square bg-cover bg-no-repeat group " style={{backgroundImage: "url('/techStacks/next.png')"}}>
                            ...
                            <div className="absolute inset-0 backdrop-blur-sm opacity-100 md:opacity-0 overflow-hidden md:group-hover:opacity-100 bg-white/10 p-4 text-white flex flex-col justify-center items-center gap-2 transition-all duration-300">
                        ...
                        <div className="relative col-span-3 md:col-span-1 row-span-1 bg-sky-200 aspect-square bg-cover bg-no-repeat group bg-[url(/techStacks/react.png)]"  >
                            ...
                            <div className="absolute inset-0 backdrop-blur-sm opacity-100 md:opacity-0 md:group-hover:opacity-100 overflow-hidden bg-white/10 p-4 text-white flex flex-col justify-center items-center gap-2 transition-all duration-300">
